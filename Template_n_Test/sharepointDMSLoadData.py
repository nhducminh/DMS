...
def MasterData1(sourcePath,fileName):
...
def MasterData2(sourcePath,fileName):
...
with DAG(
    ...
    with TaskGroup("section_1", tooltip="Tasks for Load Data") as section_1:
        ...
        def MasterData():
            ...
            sourcePath = localPath + "/Units"
            # Get a list of file paths for files with the specified name pattern in the given directory
            MasterData1(sourcePath,"dfUnits.csv")

            # %% Get latest Danh_sach_nhanVien file
            sourcePath = localPath + "/Danh_sach_nhan_vien"
            # Get a list of file paths for files with the specified name pattern in the given directory
            MasterData1(sourcePath,"dfDSNV.csv")

            # %% Get latest Danh_sach_nhanVien file
            sourcePath = localPath + "/Thong_Tin_San_Pham"
            # Get a list of file paths for files with the specified name pattern in the given directory
            MasterData2(sourcePath,"dfDSSP.csv")
            # %% Get latest Danh_sach_nhanVien file
            sourcePath = localPath + "/Du_lieu_danh_muc_khachhang"
            # Get a list of file paths for files with the specified name pattern in the given directory
            MasterData2(sourcePath,"dfDSKHC2.csv")
